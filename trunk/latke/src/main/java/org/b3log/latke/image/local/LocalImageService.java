...
public final class LocalImageService implements ImageService {
    ...
    public Image makeImage(final List<Image> images) {
        ...
        try {
            ...
            BufferedImage tmp =
                    ImageIO.read(new ByteArrayInputStream(firstImage.getData()));
     ...
     */
    private static BufferedImage splice(
            final java.awt.Image image1, final java.awt.Image image2) {
        final int[][] size = {
        ...
        final BufferedImage ret = new BufferedImage(width,
                                                    height,
